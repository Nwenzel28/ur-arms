            ...
            try:
                ...
                if action == 'ik':
                    ...
                    if socket_open("{my_ip}", {port}, "cb"):
                        ...
                        socket_send_string(to_str(q[1]), "cb")
                        socket_send_string(",", "cb")
                        socket_send_string(to_str(q[2]), "cb")
                        socket_send_string(",", "cb")
                        socket_send_string(to_str(q[3]), "cb")
                        socket_send_string(",", "cb")
                        socket_send_string(to_str(q[4]), "cb")
                        socket_send_string(",", "cb")
                        socket_send_string(to_str(q[5]), "cb")
                        socket_close("cb")
                    end
                    end\n"""
                else:
                    ...
                    if socket_open("{my_ip}", {port}, "cb"):
                        socket_send_string(to_str(pose[0]), "cb")
                        socket_send_string(",", "cb")
                        socket_send_string(to_str(pose[1]), "cb")
                        socket_send_string(",", "cb")
                        socket_send_string(to_str(pose[2]), "cb")
                        socket_send_string(",", "cb")
                        socket_send_string(to_str(pose[3]), "cb")
                        socket_send_string(",", "cb")
                        socket_send_string(to_str(pose[4]), "cb")
                        socket_send_string(",", "cb")
                        socket_send_string(to_str(pose[5]), "cb")
                        socket_close("cb")
                    end
                    end\n"""
